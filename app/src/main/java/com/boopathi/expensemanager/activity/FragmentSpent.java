...
import com.boopathi.expensemanager.adapter.SpentTransAdapter;
...
public class FragmentSpent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) layout.findViewById(R.id.transSpentRecycler);
        ...
        data = dbHelper.getModeTrans(0);

        adapter = new SpentTransAdapter(data, getContext());
